...
// Request to register a new Checker-Orchestrator
...
// Response after registrating Checker-Orchestrator
type RegisterCheckerResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // UUID of the created Checker-Orchestrator
}
...
// Request to check the status of a Checker-Orchestrator
type PingCheckerRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"` // UUID of the Checker-Orchestrator
}
...
// Миша, не реализована функциональность с флагом. Как сервис Control будет знать, какие флаги валидны?
