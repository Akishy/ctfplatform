...
const (
	...
	ServiceDeployer_StartInstances_FullMethodName = "/deployer.ServiceDeployer/StartInstances"
...
func (c *serviceDeployerClient) StartInstances(ctx context.Context, in *StartInstancesRequest, opts ...grpc.CallOption) (*StartInstancesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartInstancesResponse)
	err := c.cc.Invoke(ctx, ServiceDeployer_StartInstances_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedServiceDeployerServer) StartInstances(context.Context, *StartInstancesRequest) (*StartInstancesResponse, error) {
...
func _ServiceDeployer_StartInstances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartInstancesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceDeployerServer).StartInstances(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ServiceDeployer_StartInstances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceDeployerServer).StartInstances(ctx, req.(*StartInstancesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServiceDeployer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ServiceDeployer_StartInstances_Handler,
		},
		{
